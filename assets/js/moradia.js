...
function modoCor(){
    let botaoCor = document.querySelector(".color-model")
    botaoCor.addEventListener("click", modoCor)
    document.querySelector(".color-model").classList.toggle("change_color")
